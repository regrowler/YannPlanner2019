...
import info.androidhive.navigationdrawer.NonScrollListView;
...
//        });
   ...
   /* @OnItemClick(R.id.listView)
    void onItemClick(int position) {
        Toast.makeText("Position "+position+" is clicked",getActivity(),Toast.LENGTH_SHORT).show();
    }
*/
    @Override
