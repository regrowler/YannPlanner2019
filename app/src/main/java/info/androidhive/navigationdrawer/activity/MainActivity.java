...
//                Snackbar.make(view, "По этой кнопке будет добавляться действие", Snackbar.LENGTH_LONG)
//                        .setAction("Action", null).show();
    ...
    private void loadNavHeader() {
        // name, website
        txtName.setText("Планировщик дел");
        txtWebsite.setText("Успей все!");
    ...
    private Fragment getHomeFragment() {
        switch (navItemIndex) {
            ...
            case 2:
                ...
                Log.d(TAG, "создаем списковый фрагмент и возвращаем его");
...
//            Toast.makeText(getApplicationContext(), "По этой кнопке будет переходить на уровень выше или ниже", Toast.LENGTH_LONG).show();
//            return true;
//        }
